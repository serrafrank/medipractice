...
DROP DATABASE medipractice;
--
-- TOC entry 2920 (class 1262 OID 16393)
-- Name: medipractice; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE medipractice WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'French_France.1252' LC_CTYPE = 'French_France.1252';


ALTER DATABASE medipractice OWNER TO postgres;

\connect medipractice
